...
Το μήκος της διαδρομής είναι 1.3696755979043929 km όπως και στην διαδρομή που προτείνει το Google Maps. Το kml αρχείο βρίσκεται στο \texttt{original.kml}.
...
\paragraph{Αξιολόγηση Ευριστικής -- Δύο Στόχοι} Στο πρώτο testcase δημιουργήσαμε δύο στόχους οι οποίοι βρίσκονται 0.409 km και 0.410 km από τον πελάτη. Παρατηρούμε ότι ο αλγόριθμός μας βρίσκει τη σωστή λύση με απόσταση 0.4096554673706844 km.
\begin{figure}[htp]
\centering
...
\paragraph{Ισοδύναμα μονοπάτια} Στο testcase που μας δίνεται βάζουμε tolerance 10m. Το αποτέλεσμα είναι το ακόλουθο το οποίο αποτυπώνει και διαδρομές με similar ETA. 

\begin{figure}[htp]
\centering
\includegraphics[scale=0.30]{tolerant.png}
\caption{Ισοδύναμες Διαδρομές με tolerance 10m}
\label{}
\end{figure}

Η γλώσσα KML δεν μας επέτρεπε να ορίσουμε βέλη για να δείξουμε την κατεύθυνση στο DAG. Αυτό μπορούμε να το λύσουμε με χρήση μιας αναζήτησης DFS στο DAG. 

\begin{figure}[htp]
\centering
\includegraphics[scale=0.40]{tolerant_arr.png}
